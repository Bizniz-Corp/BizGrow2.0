...
<body>
    ...
    <header class="hero-section d-flex flex-column justify-content-center align-items-center text-center">
        ...
        <p class="lead mb-4">Empower your small business with smart predictions for demand, profit, and stock tracking.
        </p>
        <div>
            <a href="{{ route('register') }}" class="btn btn-lg btn-custom btn-signup me-3">Sign Up</a>
            <a href="{{ route('login') }}" class="btn btn-lg btn-custom btn-signin">Sign In</a>
        </div>
    </header>
